...
export default Vue.extend({
  ...
  computed: {
    ...
    turnstileSiteKey: {
      ...
      set(value: string) {
        this.$store.commit('kod-mobi.store/setTurnstileSiteKey', value);
      }
    }
  },
});
...
<template>
  <div class="flex flex-col items-center justify-start h-full w-full mt-4 p-4 rounded-2xl bg-base-200">
    ...
    <div class="form-control w-full">
      ...
      <input v-model="apiKey" autocomplete="off" type="text" placeholder="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"
    ...
    <div class="form-control w-full">
      ...
      <input v-model="secretKey" type="password" autocomplete="off" placeholder="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"
             class="input input-bordered w-full"/>
      <label class="label">
    ...
    <div class="form-control w-full">
      <label class="label">
        <span class="label-text">Turnstile Site Key</span>
        <span class="label-text-alt"></span>
      </label>
      <input v-model="turnstileSiteKey" type="password" autocomplete="off" placeholder="xxxxxxxxxxxxxxxxxxxxx"
             class="input input-bordered w-full"/>
      <label class="label">
        <span class="label-text-alt">Cloudflare challenge</span>
        <span class="label-text-alt"></span>
      </label>
    </div>
